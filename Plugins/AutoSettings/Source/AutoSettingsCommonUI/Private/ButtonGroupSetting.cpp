...
void UButtonGroupSetting::NativePreConstruct()
{
...
void UButtonGroupSetting::UpdateOptions_Implementation(const TArray<FSettingOption>& InOptions)
{
...
void UButtonGroupSetting::HandleButtonCreation_Implementation(UCommonButtonBase* NewButton, const FSettingOption& Option)
{
}

void UButtonGroupSetting::HandleButtonRemoval_Implementation(UCommonButtonBase* NewButton)
{
}

void UButtonGroupSetting::UpdateSelection_Implementation(const FString& Value)
{
...
void UButtonGroupSetting::NativeDestruct()
{
...
void UButtonGroupSetting::RemoveAllButtons()
{
