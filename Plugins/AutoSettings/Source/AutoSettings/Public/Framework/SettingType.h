...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, Instanced, NoClear, Category = "Setting")
	class USettingApplicationStrategy* ApplicationStrategy = nullptr;
	 ...
	 */
	UPROPERTY(EditAnywhere, Category = "Setting", meta=(InlineEditConditionToggle))
	 ...
	 */
	UPROPERTY(EditAnywhere, Category = "Setting", meta=(EditCondition=bOverrideDefaultValue))
...
private:
	 ...
	 * Delegates to the ApplicationStrategy to perform the actual application
