...
#include "InputSettingApplicationStrategy.generated.h"
 ...
 */
UCLASS()
class AUTOSETTINGSINPUT_API UInputSettingApplicationStrategy : public USettingApplicationStrategy
{
	GENERATED_BODY()

public:
	virtual bool CanRegister_Implementation(const FSettingContext& Context) override;
