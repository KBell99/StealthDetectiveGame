...
public:
	...
	/** Configure this widget to use the specified setting type and key extension */
	UFUNCTION(BlueprintCallable, Category = "Setting")
	void SetSetting(TSubclassOf<USettingType> SettingType, FPartialSettingKey SubKey);
...
protected:
	/** The setting type asset that defines this widget's behavior and data source */
	UPROPERTY(EditAnywhere, Category = "Target")
	TSubclassOf<USettingType> SettingType;

	/** Additional key fragments to append to the setting's base key for hierarchical settings */
	UPROPERTY(EditAnywhere, Category = "Target")
...
private:
	...
	UFUNCTION()
	void OnAppliedValueModified(const FSettingReference& Setting);
